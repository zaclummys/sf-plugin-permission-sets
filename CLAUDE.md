...
> One runner, two suites, split by what they drive. **Mocha** throughout, and neither suite mocks a module, fakes a timer, or imports `src/`: both read the working tree's `lib/`, never the published package.
>
